...
<aside class="sidebar">
    ...
    <nav class="nav flex-column">
        <a class="nav-link {{ request()->routeIs('teacher.dashboard') ? 'active' : '' }}" href="{{ route('teacher.dashboard') }}"><i class="fa-solid fa-grip"></i> Dashboard</a>
        <a class="nav-link" href="/teacher-attendance">
            <i class="fa-solid fa-calendar-check"></i> Attendance
        </a>
        <a href="{{ route('teacher.resources.index') }}" class="nav-link {{ request()->routeIs('teacher.resources.*') ? 'active' : '' }}"><i class="fa-solid fa-folder-tree"></i> Resources</a>
        <a class="nav-link" href="/teacher-exams"><i class="fa-solid fa-file-pen"></i> Exams</a>
    </nav>
    ...
    <nav class="nav flex-column">
        ...
        <a class="nav-link" href="#"><i class="fa-solid fa-chart-pie"></i> Reports</a>
    </nav>
