                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="school_type" class="form-select bg-light rounded-3 small" required>
                                    ...
                                    <option value="pre_primary" {{ old('school_type', $school->school_type) == 'pre_primary' ? 'selected' : '' }}>Pre Primary</option>
                                    ...
                                    <option value="all" {{ old('school_type', $school->school_type) == 'all' ? 'selected' : '' }}>All Levels (Mixed)</option>
                                </select>
                            </div>
